...
class Impersonate extends Field
{
    ...
    public function __construct($user = null)
    {
        ...
        $this->withMeta([
            'key_down' => config('admin-impersonate.key_down'),
            'redirect_to' => config('admin-impersonate.redirect_to'),
            'enable_multi_guard' => config('admin-impersonate.enable_multi_guard'),
            'impersonator_guards' =>  config('admin-impersonate.impersonator_guards'),
            'default_impersonator_guard' =>  config('admin-impersonate.default_impersonator_guard'),
